...
# Verificar los valores faltantes en el atributo 'Headquarters Location'
nodos$`Headquarters Location`[is.na(nodos$`Headquarters Location`)] <- "Unknown"

# Agregar atributos de los nodos a la red
...
m1 <- ergm(samplike ~ edges + nodematch("location"))
